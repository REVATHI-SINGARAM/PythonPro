...
def update_output_container(input_year, input_s):
    if input_s == 'Recession Period Statistics':
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.line(average_sales, 
                x='Year',
                y='Automobile_Sales',
                title="Average Automobile Sales fluctuation over Recession Period - Vehicle Type"))
...
#TASK 2.6: Returning the graphs for display
 ...
 # Yearly Statistic Repot Plots                             
    elif (input_year and input_s=='Yearly Statistics') :
...
# Plot 2 Total Monthly Automobile sales using line chart.
        yas1= data.groupby('Month')['Automobile_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(figure=px.line(yas1,
                            x='Month',
                            y='Automobile_Sales',
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,values='Advertising_Expenditure',names='Vehicle_Type',title="Total Advertisement Expenditure for each vehicle using pie chart"))
#TASK 2.6: Returning the graphs for display
        return [
